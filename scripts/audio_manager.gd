...
func _ready():
    ...
    if ResourceLoader.exists("res://assets/audio/music.ogg"):
        ...
        # fallback: runtime synth ambient
        synth_fallback = preload("res://scripts/overworld_ambient.gd").new()
        add_child(synth_fallback)
        synth_fallback.play_music()
...
func play_hit():
    if sfx_player and ResourceLoader.exists("res://assets/audio/hit.ogg"):
        ...
        sfx_player.play()
    elif synth_fallback and synth_fallback.has_method("play_hit"):
...
func play_special():
    if sfx_player and ResourceLoader.exists("res://assets/audio/special.ogg"):
        ...
        sfx_player.play()
    elif synth_fallback and synth_fallback.has_method("play_special"):
        synth_fallback.play_special()

func play_music():
    if music_player:
        music_player.play()
    elif synth_fallback and synth_fallback.has_method("play_music"):
        synth_fallback.play_music()
